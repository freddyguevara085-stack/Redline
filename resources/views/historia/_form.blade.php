...
<div class="form-row form-row--two-column">
  ...
  @if(optional($historia)->cover_url)
    <div class="form-group form-group--full">
      ...
      <img src="{{ $historia->cover_url }}" alt="Portada actual" style="max-width: min(320px, 100%); border-radius: 12px; box-shadow: var(--shadow-sm);">
  ...
  <div class="form-footer form-group--full">
